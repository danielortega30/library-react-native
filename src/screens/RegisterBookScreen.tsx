...
type Props = {
  navigation: NativeStackNavigationProp<RootStackParamList, 'RegisterBook'>;
};

const RegisterBookScreen: React.FC<Props> = ({ navigation }) => {
  const {
    bookName,
    setBookName,
    isbn,
    ...
    statusOptions,
    handleSubmit,
  } = useRegisterBook(() => navigation.navigate('BookList'));
